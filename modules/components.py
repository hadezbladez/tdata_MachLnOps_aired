...
def init_components(data_dir, transform_module,
        training_module, tuner_module, training_steps,
        eval_steps, serving_model_dir, ):
    ...
    evaluator = Evaluator(
        examples=transform.outputs['transformed_examples'], #example_gen.outputs['examples']
